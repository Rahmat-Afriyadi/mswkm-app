      ...
      <div className="w-full">
        <div className="w-full flex justify-center">
          <input
            ...
            } bg-white text-black border-0 focus:ring-0 focus:border-none outline-none focus:outline-none text-center h-6 sm:h-12`}
          />
        </div>
        {seearchBox && (
          <div className="h-auto">
            <div className="mx-auto w-3/4 max-h-72 z-0 bg-white -mt-3 rounded-b-xl pt-2 pr-5">
