              ...
              <button
                ...
                className={
                  parseInt(page.current) === number
                    ? "relative z-10 inline-flex items-center px-4 py-2 text-sm font-semibold text-yellow bg-black text-blue-500 focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600"
